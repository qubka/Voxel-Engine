...
The event dispatcher class is designed so as to be used in a frame. It allows
...
This way users can embed the dispatcher in a frame and literally dispatch events
